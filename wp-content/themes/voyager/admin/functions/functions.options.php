...
if (!function_exists('of_options'))
{
	function of_options()
	{
		...
		$favicon_iphone_images_uri = get_stylesheet_directory_uri() .'/images/favicon_57x57.png';
		$favicon_ipad_images_uri = get_stylesheet_directory_uri() .'/images/favicon_72x72.png';
		$favicon_iphone_retina_images_uri = get_stylesheet_directory_uri() .'/images/favicon_114x114.png';
...
$of_options[] = array( 	"name" 		=> esc_html__( 'Retina Favicon for iPhone (114x114)', 'voyager' ),
						...
						"std" 		=> $favicon_iphone_retina_images_uri,
						"mod" 		=> "min",
						"fold" 		=> "favicon_retina",
						"type" 		=> "upload"
				);
...
$of_options[] = array( 	"name" 		=> esc_html__( 'Access Token', 'voyager' ),
						"desc" 		=> esc_html__( 'A valid oAuth token. Can be used in place of a client ID. <a href="http://jelled.com/instagram/access-token" target="_blank">link</a>', 'voyager' ),
