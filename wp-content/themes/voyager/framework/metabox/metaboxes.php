...
function savePostMeta($post_id) {
    global $cs_custom_layout_settings, $cs_page_settings, $cs_page_portfolio_settings, $cs_portfolio_single, $cs_portfolio_single_gallery, $cs_portfolio_single_video, $cs_portfolio_single_audio, $cs_comingsoon_settings;
