...
function wordpress_importer_init() {
	...
	register_importer( 'wordpress', 'WordPress', esc_html__('Import posts, pages, comments, custom fields, categories, and tags from a WordPress export file.', 'wordpress-importer'), array( $GLOBALS['wp_import'], 'dispatch' ) );
}
