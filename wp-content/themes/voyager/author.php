				...
				<div id="author_posts_info" class="clearfix">
					<div class="container text-center">
						...
						<div class="author_posts_descr">
							<div class="author_posts_count"><?php echo esc_html__( $evatheme_user_post_count . ' articles','voyager') ?></div>
								...
								<div class="author_icons">
									<?php
										...
										if ( $evatheme_author_linkedin_profile && $evatheme_author_linkedin_profile != '' ) {
											   echo '<a class="social_link facebook" href="' . esc_url($evatheme_author_linkedin_profile) . '" target="_blank"><i class="fa fa-facebook"></i></a>';
										}
