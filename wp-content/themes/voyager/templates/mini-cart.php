		...
		<div class="widget_shopping_cart_content">
			...
			<div id="cs-mini-cart-inner-empty"<?php echo $empty_class; ?>>
				...
				<div class="cs-mini-cart-summary">
					<div class="buttons">
						<a href="#" id="cs-mini-cart-empty-continue" class="button view-cart"><?php esc_html_e( 'Continue Shopping', 'voyager' ); ?></a>
					</div>
				</div>
			</div>
			...
			<div id="cs-mini-cart-inner">
				...
				<div class="cs-mini-cart-summary">
					<div class="total"><strong><?php esc_attr( 'Subtotal', 'voyager' ); ?></strong> <span id="cs-mini-cart-subtotal" class="cs-mini-cart-subtotal"><?php echo WC()->cart->get_cart_subtotal(); ?></span></div>
				
					<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>
				
					<div class="buttons">
						<a href="<?php echo WC()->cart->get_cart_url(); ?>" class="button view-cart wc-forward"><?php esc_attr( 'Edit Cart', 'voyager' ); ?></a>
						<a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="button checkout wc-forward"><?php esc_attr( 'Checkout', 'voyager' ); ?></a>
					</div>
				</div>
			</div>
